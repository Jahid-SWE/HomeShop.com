            ...
            <div class="content col-sm-9">
                <div class="blog1 blog">
                    ...
                    <div class="author-about">
                        ...
                        <div class="author">
                            <div class="author-avatar"> <a href="#"><img alt="" src="{{ asset('/') }}Frontend/image/user1.jpg"></a> </div>
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <article class="comment-body">
                                    <div class="comment-avatar"> <img alt="" src="{{ asset('/') }}Frontend/image/user2.jpg"> </div>
                                    <div class="comment-main">
                                        ...
                                        <div class="comment-content">Sed lobortis rpis porttitor larpis porttitor larpis porttitor lauctus. Aenean posuere nulla in turpis porttitor laoreet. Quisque finibus aliquet purus.</div>
                                    </div>
                                </article>
                                <ol class="children">
                                    <li class="comment">
                                        <article class="comment-body">
                                            <div class="comment-avatar"> <img alt="" src="{{ asset('/') }}Frontend/image/user3.jpg"> </div>
                                            <div class="comment-main">
                                                <h5 class="author-name"> <a href="#" class="comment-name">Lobortis Radley</a> <small class="comment-date">1 months ago</small> </h5>
                                                <div class="comment-reply"> <a href="#">Reply</a> </div>
                                                <div class="comment-content">Dcenas euismod faucibus dolor a finibus.Maecenas euismod faucibus dolor a finibus.Maecenas euismod faucibus dolor a finibus.Maecenas euismod faucibus dolor a finibus.cenas euismod faucibus dolor a finibus.</div>
                                            </div>
                                        </article>
                                    </li>
                                </ol>
                            ...
                            <li class="comment">
                                <article class="comment-body">
                                    <div class="comment-avatar"> <img alt="" src="{{ asset('/') }}Frontend/image/user1.jpg"> </div>
                                    <div class="comment-main">
                                        <h5 class="author-name"> <a href="#" class="comment-name">Sradle Vivamus </a> <small class="comment-date">8 days ago</small> </h5>
                                        <div class="comment-reply"> <a href="#">Reply</a> </div>
                                        <div class="comment-content">Vivamus imperdiet ex sed lobortis luctus. Aenean posuere nulla in turpis porttitor laoreet. Quisque finibus aliquet purus. Ut et mi eu ante interdum dignissim pellentesque a mi.</div>
                                    </div>
                                </article>
                            </li>
                        </ul>
