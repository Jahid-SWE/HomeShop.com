        ...
        <div class="row">
            <div id="column-left" class="col-sm-3 hidden-xs column-left">
                ...
                <div class="latest left-sidebar-widget">
                    <div class="columnblock-title">Latest Product</div>
                    <ul class="row ">
                        ...
                        <li class="product-layout">
                            <div class="product-list col-xs-4">
                                <div class="product-thumb">
                                    <div class="image product-imageblock"> <a href="product.html">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-04.jpg">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-04-1.jpg">
                                        </a> </div>
                                </div>
                            </div>
                            <div class="col-xs-8">
                        ...
                        <li class="product-layout">
                            <div class="product-list col-xs-4">
                                <div class="product-thumb">
                                    <div class="image product-imageblock"> <a href="product.html">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-08.jpg">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-08-1.jpg">
                                        </a> </div>
                                </div>
                            </div>
                            <div class="col-xs-8">
