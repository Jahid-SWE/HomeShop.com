    ...
    <div class="container">
        <div class="row">
            <div id="column-left" class="col-sm-3 hidden-xs column-left">
                ...
                <div class="banner left-sidebar-widget"> <a href="#"><img src="{{ asset('/') }}Frontend/image/banners/LeftBanner.jpg" alt="Left Banner" class="img-responsive" /></a> </div>
                    ...
                    <ul class="row ">
                            ...
                            <div class="product-list col-xs-4">
                                <div class="product-thumb">
                                    <div class="image product-imageblock">
                                        <a href="product.html">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-06.jpg">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-06-1.jpg">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-list col-xs-4">
                                <div class="product-thumb">
                                    <div class="image product-imageblock"> <a href="product.html">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-02.jpg">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-02-1.jpg">
                                        </a> </div>
                                </div>
                            </div>
                            <div class="col-xs-8">
                        ...
                        <li class="product-layout">
                            <div class="product-list col-xs-4">
                                <div class="product-thumb">
                                    <div class="image product-imageblock"> <a href="product.html">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-03.jpg">
                                            <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="{{ asset('/') }}Frontend/image/product/Pro-03-1.jpg">
                                        </a> </div>
                                </div>
                            </div>
                            <div class="col-xs-8">
                ...
                <div class="grid-list-wrapper">
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock">
                                <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-04.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-04-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-03.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-03-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-06.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-06-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-07.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-07-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-08.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-08-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-09.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-09-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-010.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-010-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock"> <a href="product.html">
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-01.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                    <img src="{{ asset('/') }}Frontend/image/product/Pro-01-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" />
                                </a>
                                <ul class="button-group grid-btn">
                                    <li>
                                        <button type="button" class="wishlist" data-toggle="tooltip" data-placement="top" title="Add to Wish List" ><i class="fa fa-heart-o"></i></button>
