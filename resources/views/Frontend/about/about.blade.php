...
@section('about')
    ...
    <div class="container">
        <div class="row">
            <div class="wwd">
                <div class="col-sm-5"><img class="img-responsive" src="{{ asset('/') }}Frontend/image/about-us.jpg" alt="#"></div>
                <div class="col-sm-7">
                    <div class="column-inner ">
                        <div class="wrapper">
                            <h4 class="aboutus-title">We made a unique &amp; Beautyfull theme </h4>
                            <div class="desc">
        ...
        <div class="row team">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6 team1 ">
                <div class="img-block"> <img alt="#" src="{{ asset('/') }}Frontend/image/team1.jpg" class="img-responsive"> </div>
                <div class="text-box">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6 team2 ">
                <div class="img-block"> <img alt="#" src="{{ asset('/') }}Frontend/image/team2.jpg" class="img-responsive"> </div>
                <div class="text-box">
                    <h3 class="name">Joeby Ragpa</h3>
                    <div class="deg">CEO Founder </div>
                    <p>make a type specimen book. It has survived not only five centuries, but also the leap</p>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6 team3 ">
                <div class="img-block"> <img alt="#" src="{{ asset('/') }}Frontend/image/team3.jpg" class="img-responsive"> </div>
                <div class="text-box">
                    <h3 class="name">Joeby Ragpa</h3>
                    <div class="deg">CEO Founder </div>
                    <p>make a type specimen book. It has survived not only five centuries, but also the leap</p>
            ...
            <div class="col-md-3 col-sm-3  col-xs-6 team4 ">
                <div class="img-block"> <img alt="#" src="{{ asset('/') }}Frontend/image/team4.jpg" class="img-responsive"> </div>
                <div class="text-box">
                    <h3 class="name">Joeby Ragpa</h3>
                    <div class="deg">CEO Founder </div>
                    <p>make a type specimen book. It has survived not only five centuries, but also the leap</p>
